...
class AVDataset_CD(Dataset):
  def __init__(self, mode='train'):
    ...
    self.visual_path = 'cremad/visual/'
    self.audio_path = 'cremad/audio/'

    
    self.stat_path = 'cremad/stat.csv'
    self.train_txt = 'cremad/train.csv'
    self.my_train_txt = 'cremad/my_train.csv'
    self.test_txt = 'cremad/test.csv'
    self.val_txt='cremad/val.csv'
    if mode == 'train':
